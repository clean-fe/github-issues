...
export default class IssueViewModel extends Observable {
  ...
  // 방법 1. ViewModel 이 Model 로부터 Closure 를 호출 후 받게 됨으로 해당 함수 내에서 다음 라인으로 넘어가지 않으려면
  ...
  // 방법 2. Model 을 호출 후 종료되기 때문에 해당 함수 내에서는 다음 라인으로 넘어가지 않음. 즉, 바로 Model 로 스레드가 넘어가니까
